...
export function NewNoteCard() {
    ...
    function handleContentChanged(event: ChangeEvent<HTMLTemplateElement>) {
            ...
            <Dialog.Portal>
                ...
                >
                    ...
                    <button
                        type="button"
                        className={
                            'w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500'
                        }
                    >
                        Clique-me e salvarás
                    </button>
                </Dialog.Content>
            </Dialog.Portal>
        </Dialog.Root>
